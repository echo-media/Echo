...
const SinglePost = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const response = await fetch(`https://echo-three-nu.vercel.app/api/posts/getone/${postid}`)
    ...
    const fetchComment = async () => {
      try {
        const response = await fetch(`https://echo-three-nu.vercel.app/api/comments/getpostscomments/${postid}`)
